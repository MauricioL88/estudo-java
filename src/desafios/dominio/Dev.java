...
public class Dev {
    ...
    /*
     * - Os conteúdo só podem ser acionados de forma única, por isso se faz
     * necessário a utilização
     * da coleção "Set" para que não exista duplicação nas inscrições.
     * 
     * - A medida que o aluno (dev) for se increvendo em algum conteúdo ou
     * concluindo,
     * será adicionado em ordem.
     */
